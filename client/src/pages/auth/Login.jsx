        ...
        <RightContent>
          ...
          <XForm component="form"
            ...
            <FormDiv>
              ...
              <SmallText><Link className="link" to="/password-reset" >Has olvidado tu contraseña?</Link></SmallText>
            </FormDiv>
          ...
          <SmallText>
            No tienes cuenta todavía? <Link className="link" to="/contact">Contacta con Factoria F5</Link>
          </SmallText>
        </RightContent>
      </View>
      <Footer />
